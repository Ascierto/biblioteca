...
$user = \Biblos\Users::showUsers($data);
                ...
                <div class="col-12 col-md-6 card p-5">
                    <form method="POST" action="./includes/update-user.php?id=<?php echo $_GET['id'] ;?>">
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="name" value="<?php echo $user[0]['name'] ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="surname" class="form-label">Cognome</label>
                            <input name="surname" type="text" class="form-control" id="surname" value="<?php echo $user[0]['surname'] ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleEmail1" class="form-label">Indirizzo email</label>
                            <input name="email" type="email" class="form-control" id="exampleEmail1" aria-describedby="emailHelp" value="<?php echo $user[0]['email'] ?>" required>
                        </div>
                        <div class="mb-3">
